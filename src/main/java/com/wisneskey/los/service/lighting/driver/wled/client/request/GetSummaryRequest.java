...
/**
 * Request for getting the summary object from a WLED controller. The summary
 * object contains all information that can be obtained from the controller. It
 * is considered a read only object.
 * 
